//
//  FriendCahtingViewControlleroneViewController.h
//  Play_Date
//
...
@interface FriendCahtingViewControlleroneViewController : UIViewController<UITableViewDelegate,UITableViewDataSource>
